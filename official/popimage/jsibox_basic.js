...
var jsiBox = {
	// НАСТРОЙКИ //
	boxBorderColor : '#043a86',          // Цвет границы бокса
	boxBorderWidth : '5px',              // Толщина границы бокса
	boxBgColor     : '#fff',          // Цвет фона бокса
	imgBgColor     : '#fff',          // Цвет подложки изображения 
	overlayColor   : '#011b3f',          // Цвет затемнения страницы
	...
	//statusString   : 'Photo&nbsp;[num]&nbsp;of&nbsp;[total]', // Строка описания текущего соcтояния  
...
function jsiBoxInit()
{
	...
	var boxHTML =  '<style type="text/css">#jsiMainBox * {margin: 0; padding: 0; border: 0; text-decoration: none;} #jsiMainBox a.jsiBtn {outline: none; float:right; color: #000; font-size: 30px; width: 40px;  vertical-align:middle;font-weight:normal; } </style>'
                  ...
                  +'  <div id="jsiMainBox" style="color: #000; text-align:left;position: relative; display: none; margin: auto; z-index: 2; width: 400px; background:'+jsiBox.boxBgColor+'; border: '+jsiBox.boxBorderWidth+' solid '+jsiBox.boxBorderColor+'; padding-bottom: 4px;">'
                  +'      <p style="text-align: right; font: bold 13px arial; padding-top: 0;width:100%;overflow:hidden;padding-bottom:0;">'
                  ...
                  +'      </div>'
                  +'      <span id="jsiBoxTitle" style="margin:0 8px; font: normal 13px arial;"></span>'
                  +'  </div>'
                  +'</div>';
